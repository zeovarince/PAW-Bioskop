    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
        ...
        <div class="bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200">
            <div class="p-6 border-b bg-gray-50">
                <h3 class="text-xl font-bold text-gray-800">Riwayat Pemesanan</h3>
            </div>
                        ...
                        <?php if (mysqli_num_rows($result_history) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm">
                                    ...
                                    <p class="text-xs text-gray-500"><i class="ph ph-calendar-blank mr-1"></i> <?= date('d M Y, H:i', strtotime($row['Waktu_tayang'])) ?> di Studio <?= htmlspecialchars($row['nama_studio']) ?></p>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <?php if ($status == '2'): ?>
                                        <a href="payment_confirm.php?id_booking=<?= $row['Id_booking'] ?>" class="text-cinemaRed hover:text-red-700 font-bold transition">
                                            Lanjut Bayar
                                        </a>
                                    <?php elseif ($status == '1'): ?>
                                        <button onclick="alert('Tiket sudah dikonfirmasi. Siap ditonton!')" class="text-blue-600 hover:text-blue-800 font-bold transition">
                                            Cetak Tiket
                                        </button>
                                    <?php else: ?>
                                        -
